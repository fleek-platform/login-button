...
export type CreateContextReturn<T> = [React.Provider<T>, (nothrow?: boolean) => T, React.Context<T>];
...
export const createContext = <T>({ name, hookName, providerName }: CreateContextArgs): CreateContextReturn<T> => {
